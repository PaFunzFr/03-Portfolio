...
export class ProjectsComponent {
  allProjects: projects[] = [
    {
      ...
      about:
        'https://www.dreso.com/lu/en/projects/details/fraport-terminal-3-frankfurt',
    },
    {
      id: 'arc.002',
      title: 'IX FRA18-22',
      ...
      about:
        'https://www.dreso.com/de/aktuelles/details/neckermann-versandzentrale-aus-den-1960ern-wird-zum-colocation-rechenzentrum',
    },
    {
      id: 'arc.003',
      title: 'DFB Campus',
    ...
    },
    {
      id: 'dev.002',
      title: 'StePat',
      image: '/assets/img/projects/stepat.png',
      about: 'https://github.com/example/project1',
      code: 'https://github.com/PaFunzFr/stepat',
    },
    {
      id: 'dev.003',
      title: 'First Web Project',
      image: '/assets/img/projects/firstweb.png',
      about: 'https://github.com/example/project1',
      code: 'https://github.com/PaFunzFr/firstattempt',
    },
    {
      id: 'dev.004',
      title: 'HulCinator',
  ...
  sortProjects() {
    const devProjects = this.allProjects
      .filter((p) => p.id.startsWith('dev'))
      .sort((a, b) => a.id.localeCompare(b.id));
    const arcProjects = this.allProjects
      .filter((p) => p.id.startsWith('arc'))
      .sort((a, b) => a.id.localeCompare(b.id));
